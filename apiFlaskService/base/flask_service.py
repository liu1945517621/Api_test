...
#
#     db = pymysql.connect(host="172.17.47.161", port=3306, user="wlyzhwl_test", password="zjxl2021#",
#                          database="wlyzhwl_test", charset='utf8')
#
#     # 创建数据库游标
#     cursor = db.cursor(cursor=pymysql.cursors.DictCursor)
#
#     # 执行数据库查询
#     query = "SELECT * FROM wlyzhwl_test.tb_schedule WHERE schedule_no = %s"
