...
FILE_PATH = {
    ...
    'LOGIN': os.path.join(DIR_BASE, 'testcase/login/login.yaml'),
    'PRODUCT': os.path.join(DIR_BASE, 'testcase/ProductManager/getProductList.yaml'),
    'PRODUCTDetail': os.path.join(DIR_BASE, 'testcase/ProductManager/productDetail.yaml'),
